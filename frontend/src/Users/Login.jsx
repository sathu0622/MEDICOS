      ...
      <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md mt-40 mb-8 border border-gray-100">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div>
            ...
            <input
              type="email"
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#007BFF]"
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              required
            />
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-[#007BFF] text-white py-3 rounded-lg hover:bg-[#0056b3]"
          >
            {isLoading ? "Logging in..." : "Login"}
          </button>
          ...
          <button
            ...
            className="w-full flex items-center justify-center bg-white border py-3 rounded-lg"
          >
            <img
              src="https://developers.google.com/identity/images/g-logo.png"
              alt="Google"
          ...
          <div className="text-center mt-4">
            <p className="text-gray-600 text-sm">
              Don't have an account?{" "}
              <Link to="/Registration" className="text-[#007BFF] hover:text-[#0056b3] font-medium">
                Sign up here
              </Link>
            </p>
          </div>
