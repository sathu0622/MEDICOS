...
import api from "../services/api"; // ✅ use the configured api
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.put(`/PaymentOperations/updatepay/${id}`, {
        ...payment,
        // Never send CVV or full card number
        cvv: undefined,
            ...
            <div className="space-y-4">
              {["Repname", "email", "Contactno", "BookRef", "payRef"].map((field) => (
                <div key={field}>
                  ...
                  <input
                    type={field === "email" ? "email" : field === "Contactno" ? "tel" : "text"}
                    name={field}
                    value={payment[field]}
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    value={payment.cmonth && payment.cyear ? `${payment.cmonth}/${payment.cyear}` : ""}
                    readOnly
                    className="w-full p-3 border border-gray-300 rounded-md bg-white text-black cursor-not-allowed"
                  />
                </div>
